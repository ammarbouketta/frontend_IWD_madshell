  ...
  return (
      ...
      <div id="subs" className='relative h-[calc(100vh-80px)] flex flex-col items-center justify-center px-32  w-full z-0 intro-bg-points'>
              <div className="w-full  flex items-center justify-center ">
                  <div className="w-full flex  items-center justify-between  px-20 mb-2">
                        ...
                        <div className="w-fit flex flex-col  items-center justify-start">
                                <h2 className="font-bold text-3xl text-[#115BFF] self-start ">Take a Step Back</h2>
                                <h2 className="font-bold text-3xl text-[#115BFF] self-start ">and enjoy the moment !</h2>
