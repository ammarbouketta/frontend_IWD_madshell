    ...
    <div className="h-[calc(100vh)] flex items-center justify-center ">
       ...
       <SignIn/>
           <div className="">
               ...
               <button className="text-[#407BFF] border-[#407BFF] border-2 rounded bg-[#fff] px-10 py-1 font-bold mr-3 mb-24 mt-10">Sign in</button>
               <button className="text-[#fff] border-[#407BFF] border-2 rounded bg-[#407BFF] px-10 py-1 font-bold ml-3 mb-24 mt-10">Sign up</button>
           </div>
