    ...
    <div>
        <div className="relative h-[calc(50vh)] w-full flex flex-col items-center justify-between pt-5 shadow-md ">
            ...
            <ul className="w-11/12 m-auto flex items-center justify-center py-3 mt-5">
                <li className="w-1/4 font-medium text-3xl text-[#115BFF] flex  items-center justify-center cursor-pointer">Newest Posts</li>
                <li className="w-1/4 border-l border-[#115BFF] font-medium text-3xl text-[#115BFF] flex  items-center justify-center cursor-pointer">Active Subs</li>
                ...
                <li className="w-1/4 px-3 border-l border-[#115BFF] font-medium text-3xl text-[#115BFF] flex  items-center justify-center cursor-pointer ">Buy Now</li>
            </ul>
            </div>
        </div>
        <div id="guidness" className="relative h-[calc(50vh)] w-full flex flex-col items-center justify-center ">
