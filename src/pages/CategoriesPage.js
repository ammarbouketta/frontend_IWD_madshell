          ...
          <div className="flex justify-center text-center space-x-8 ">
              <div className='bg-white pt-10 pb-16 px-12 rounded-3xl category-card w-1/4 cursor-pointer' onClick={() => {
                ...
                window.history.go(0);
                  ...
                  <h2 className='product-sans text-[#FFC727] text-5xl font-semibold mb-10'>Pupil <br/></h2>
              ...
              <div className='bg-white pt-10 pb-16 px-12 rounded-3xl category-card w-1/4 cursor-pointer' onClick={() => {
                ...
                window.history.go(0);
                  ...
                  <h2 className='product-sans text-[#FF725E] text-5xl font-semibold mb-10'>Bachelor <br/> </h2>
              ...
              <div className='bg-white pt-10 pb-16 px-12 rounded-3xl category-card w-1/4 cursor-pointer' onClick={() => {
                ...
                window.history.go(0);
                  ...
                  <h2 className='product-sans text-[#92E3A9] text-4xl font-semibold mb-10'>College Student</h2>
