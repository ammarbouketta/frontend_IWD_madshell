  ...
  return (
      ...
      <div id="choice" className='relative h-[calc(100vh-80px)] flex flex-col items-center justify-center px-32 pt-8 mt-3 z-0'>
           ...
           <div className=" relative flex  items-center justify-center z-99 mb-10  w-full">
               <button className="border border-[#407BFF]  border-dashed hover:shadow-md hover:shadow-[#407BFF] w-80 rounded-xlh-80 mr-10 flex flex-col items-center justify-between bg-[#fff]">
               ...
               <button className="border border-[#FFC727]  border-dashed hover:shadow-md hover:shadow-[#FFC727] w-80 rounded-xl h-80 ml-10 flex flex-col items-center justify-between bg-[#fff]">
